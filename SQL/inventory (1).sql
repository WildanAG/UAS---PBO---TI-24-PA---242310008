...
--
-- Host: localhost
-- Generation Time: Jan 17, 2026 at 08:38 PM
...
(4, 'Wildan', '1003', 'STAFF'),
(5, 'doni', '1004', 'STAFF'),
(6, 'Tetew', '3673001912050002', 'STAFF');
...
(1, 'Kulit', '14/12/2026', -10, 0, 'NA', 25, 5, 5),
(2, 'Kulit Sintetis', '11/11/2025', 270, 40, 'A', 180, 20, 7),
(3, 'Karet', '09/01/2026', 300, 30, 'A', 75, 15, 3),
(4, 'Busa Ortholite', '09/01/2026', 320, 25, 'A', 105, 20, 4),
(5, 'Kain Mesh', '09/01/2026', 250, 25, 'A', 65, 20, 2),
(6, 'kain kanvas', '11/01/2026', 150, 50, 'B', 80, 15, 2),
...
INSERT INTO `items_out` (`item_out_id`, `date_out`, `quantity_out`, `item_id`) VALUES
(1, '11/01/2026', 100, 1),
(2, '12/12/2025', 200, 1),
(3, '1301', 10, 1);
...
INSERT INTO `report` (`report_id`, `item_id_report`, `report_description`, `report_date`, `employees_id_report`) VALUES
(1, 1, 'Tambah stok kulitr 100', '12/12/2025', 2),
(2, 6, 'Berkuran 500', '123456', 6);
...
--
ALTER TABLE `employees`
  MODIFY `employees_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `items_out`
  MODIFY `item_out_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
